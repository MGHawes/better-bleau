import { flatMap, groupBy, map, mapValues } from "lodash-es";
import { getTopNClimbTypes, IClimb, ITopClimbTypesWithCounts } from "../single-area/dataProcessing";
import { extractClimbsFromDom, getRightAndLeftColumns } from "../single-area/domInteraction";
